  ...
  useEffect(() => {
    async function prepare() {
      ...
      if (LOAD_MODEL_FROM_BUNDLE) {
        const modelJson = require('../../assets/offline_model/model.json');
        const modelWeights1 = require('../../assets/offline_model/group1-shard1of2.bin');
        const modelWeights2 = require('../../assets/offline_model/group1-shard2of2.bin');
